    ...
    <div>
      ...
      <div className="bg-opacity-66 navbar flex h-20 flex-row border-b border-zinc-600 bg-black text-neutral-content shadow-lg md:mb-2">
        ...
        <div className="navbar-end">
          ...
          <label
            htmlFor="my-drawer"
            className="btn-gh mr-5 items-center justify-between md:hidden"
          ...
          <div>
            <span className="absolute right-14 block h-0.5 w-12 rotate-90 bg-zinc-600"></span>
          </div>
          <div className="dropdown-end dropdown">
            <div
              tabIndex={0}
              className="btn btn-ghost btn-square mr-4 text-right"
            >
              <svg
                className="h-7 w-7"
                xmlns="http://www.w3.org/2000/svg"
